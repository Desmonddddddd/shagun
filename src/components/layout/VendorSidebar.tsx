...
const navItems: NavItem[] = [
  ...
  { label: "Services", href: "/vendor/services", icon: PackageOpen },
    ...
    <div className="flex flex-col h-full">
      ...
      <div
        className={cn(
          ...
          collapsed && !mobile ? "justify-center px-3 h-16" : "justify-between px-5 h-16"
        )}
      >
        {(!collapsed || mobile) && (
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-body text-slate bg-ivory-dark px-1.5 py-0.5 rounded-md uppercase tracking-wider">
              Vendor
            </span>
          </Link>
        )}
            ...
            >
              <Icon
                ...
                className={cn(
                  ...
                  active ? "text-gold" : "text-slate group-hover:text-charcoal"
                )}
              />
              ...
              {active && (
                <motion.div
                  layoutId={mobile ? "vendor-nav-mobile" : "vendor-nav"}
    ...
    <>
      ...
      <div className="md:hidden fixed bottom-4 left-4 z-40">
        <button
          ...
          className="w-12 h-12 bg-gold text-white rounded-full card-shadow flex items-center justify-center hover:bg-gold-dark transition-colors cursor-pointer"
